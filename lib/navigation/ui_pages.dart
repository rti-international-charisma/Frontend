...
enum Pages { Home, Login, SignUp, Profile, ForgotPassword, HeartAssessment, HeartAssessmentQuestionnaire }
...
const PageConfiguration HomePageConfig =
    PageConfiguration(key: 'Home', path: HomePagePath, uiPage: Pages.Home);
const PageConfiguration LoginPageConfig =
    PageConfiguration(key: 'Login', path: LoginPath, uiPage: Pages.Login);
const PageConfiguration SignUpConfig =
    PageConfiguration(key: 'SignUp', path: SignUpPath, uiPage: Pages.SignUp);
const PageConfiguration ProfileConfig =
    PageConfiguration(key: 'Profile', path: ProfilePath, uiPage: Pages.Profile);
...
PageConfiguration(key: 'HeartAssessmentQuestionnaire', path: HeartAssessmentQuestionnairePath, uiPage: Pages.HeartAssessmentQuestionnaire);
